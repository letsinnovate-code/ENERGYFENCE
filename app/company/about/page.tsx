            ...
            <main className="min-h-screen bg-white">
                ...
                <section className="relative h-[600px] w-full overflow-hidden bg-black">
                    ...
                    <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
                        <h1 className="mb-4 text-5xl font-bold text-white md:text-6xl">About</h1>
                ...
                <section className="bg-white px-4 py-20 md:px-8 lg:px-16">
                    <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2 md:gap-16">
                        <div className="flex flex-col justify-center">
                            <h2 className="mb-6 text-3xl font-bold leading-tight text-[#1A2332] md:text-4xl">
                        ...
                        <div className="flex flex-col justify-center">
                            <p className="text-base leading-relaxed text-[#1A2332]">
                ...
                <section className="bg-white px-4 py-20 md:px-8 lg:px-16">
                    <div className="mx-auto grid max-w-7xl gap-0 md:grid-cols-2">
                        {/* Top Left - Text */}
                        <div className="flex flex-col justify-center bg-[#E8E9ED] p-12 md:p-16">
                            <h3 className="mb-6 text-2xl font-bold text-[#1A2332] md:text-3xl">Why railway?</h3>
                            <p className="text-base leading-relaxed text-[#1A2332]">
                                <span className="text-[#0066CC]">The Hidden Sustainability Champion.</span> Railway is the safest, most efficient and most sustainable means of motorised transport. But living up to its potential requires taking radical steps to ensure the resilience and competitiveness of the system on which millions rely.
                            </p>
                        </div>
                        {/* Top Right - Image */}
                        ...
                        {/* Bottom Right - Text */}
                        <div className="flex flex-col justify-center bg-[#003D7A] p-12 md:p-16">
                ...
                <section className="bg-[#E8E9ED] px-4 py-20 md:px-8 lg:px-16">
                    <div className="mx-auto max-w-7xl">
                        <div className="mb-12 text-center">
                            <h2 className="mb-3 text-3xl font-bold text-[#1A2332] md:text-4xl">Railway's Growing Challenges</h2>
                            <p className="text-base text-[#0066CC] md:text-lg">Rising Problems in the Railway Industry</p>
                        </div>
                        <div className="grid gap-2 md:grid-cols-3">
                            {/* Card 1 */}
                            <div className="flex flex-col bg-white p-8 shadow-sm">
                                <h3 className="mb-32 text-xl font-bold text-[#1A2332]">Insufficient capacity</h3>
                                <p className="text-sm text-[#6B2C5C]">Demand for railway is expected to double by 2050</p>
                            </div>
                            {/* Card 2 */}
                            <div className="flex flex-col bg-white p-8 shadow-sm">
                                <h3 className="mb-32 text-xl font-bold text-[#1A2332]">Low reliability</h3>
                                <p className="text-sm text-[#6B2C5C]">Time of delays equivalent to 10,000 human lives p.a. globally</p>
                            </div>
                            {/* Card 3 */}
                            <div className="flex flex-col bg-white p-8 shadow-sm">
                                <h3 className="mb-32 text-xl font-bold text-[#1A2332]">Growing costs</h3>
                                <p className="text-sm text-[#6B2C5C]">$170 B in OPEX $200 B in CAPEX $400 B in delays</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="relative h-[500px] w-full overflow-hidden bg-black">
                    ...
                    <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
                        <h2 className="mb-6 max-w-4xl text-3xl font-bold text-white md:text-5xl">
                            A new era for rail empowered by data
                        </h2>
                        <p className="mb-8 max-w-3xl text-base leading-relaxed text-white/90 md:text-lg">
                        ...
                        <button className="rounded-full bg-[#0099FF] px-8 py-3 text-sm font-medium text-white transition-all hover:bg-[#0088EE]">
