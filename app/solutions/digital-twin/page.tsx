    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
                ...
                <div className="absolute bottom-20 z-10 text-center text-white max-w-4xl mx-auto px-6">
            ...
            <section className="py-20 mt-26 px-6 h-[500px] bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-32 h-[400px] items-start mb-20">
                        <div className='relative h-[300px]'>
                            <h2 className="text-2xl md:text-3xl font-normal text-[#273441] mb-6 max-w-2xl mx-auto leading-tight">
                                The future of rail infrastructure depends on more than insight, it requires the ability to act on it.
                            </h2>
                            <div className=" absolute bottom-0 left-0 w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center">
                        ...
                        <div>
                            <p className="text-[#5A6774] w-[450px] mx-auto text-md leading-8">
            ...
            <div className="grid md:grid-cols-2 gap-12 h-screen max-w-7xl mx-auto items-center">
                ...
                <div className='h-[600px] relative'>
                    ...
                    <div className='absolute bottom-10 left-0 w-full'>
                        <p className='text-[#5A6774]'>
                            Whether it’s a new vibration sensor for switches, a tilt sensor for overhead lines, or a future-facing asset monitoring use case, our ecosystem is built to respond in weeks, not years.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
                        <div className="bg-white p-8 shadow-sm">
                            ...
                            <h3 className="text-lg text-start font-semibold mb-32 text-gray-900 mb-4">
                                Reusable, interoperable components
                            </h3>
                            <p className="text-md text-start text-gray-600 leading-relaxed">
            ...
            <section className="py-20 h-screen px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className='h-[600px] relative'>
                            <p className="text-blue-500 font-medium text-start mb-4 text-xl tracking-wide">From Prototype to Portfolio</p>
                            ...
                            <p className="text-gray-600 text-md absolute bottom-10 leading-relaxed">
            ...
            <section className="py-0 h-screen px-0 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-2 h-[600px] gap-2">
                        <div className="bg-blue-900 relative p-16  flex flex-col justify-center">
                            <p className="text-blue-300 absolute top-10 left-10 text-xs font-medium mb-6 tracking-wider uppercase">01</p>
                            <div className='absolute bottom-10 left-10'>
                                <h2 className="text-3xl md:text-3xl font-light text-white mb-6 leading-tight">
                                    Rapid IoT Prototyping
                                </h2>
                                <p className="text-[#C1C9BE] text-lg leading-relaxed">
            ...
            <section className="relative py-24 px-6 h-screen bg-gradient-to-b from-black to-[#034E75] overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-light text-white mb-6">
                        Proven Impact in the Field
                    </h2>
                    <p className="text-blue-100 text-base mb-10 max-w-3xl mx-auto">
